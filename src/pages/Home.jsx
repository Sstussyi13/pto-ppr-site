      ...
      <section className="py-16 px-4 sm:px-6 bg-white border-t border-b border-gray-200">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
            ...
            Разрабатываем проектную, сметную и исполнительную документацию под любые объекты —
            от жилых домов до сложных инженерных сооружений. Работаем по всей территории РФ.
          </p>
        </div>
      </section>
